...
private slots:
    ...
    QString BuyBTCF(QString OrderType, double Quantity, double Rate);
    QString SellBTCF(QString OrderType, double Quantity, double Rate);
