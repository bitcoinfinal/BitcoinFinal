...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeBitcoinFinalAmount"))
        settings.setValue("nAnonymizeBitcoinFinalAmount", 1000);
    nAnonymizeBitcoinFinalAmount = settings.value("nAnonymizeBitcoinFinalAmount").toLongLong();
    if (settings.contains("nDarksendRounds"))
        SoftSetArg("-darksendrounds", settings.value("nDarksendRounds").toString().toStdString());
    if (settings.contains("nAnonymizeBitcoinFinalAmount"))
        SoftSetArg("-anonymizetraveamount", settings.value("nAnonymizeBitcoinFinalAmount").toString().toStdString());
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AnonymizeBitcoinFinalAmount:
            return QVariant(nAnonymizeBitcoinFinalAmount);
        case UseBlackTheme:
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case AnonymizeBitcoinFinalAmount:
            nAnonymizeBitcoinFinalAmount = value.toInt();
            settings.setValue("nAnonymizeBitcoinFinalAmount", nAnonymizeBitcoinFinalAmount);
            emit AnonymizeBitcoinFinalAmountChanged(nAnonymizeBitcoinFinalAmount);
            break;
        default:
            break;
        }
