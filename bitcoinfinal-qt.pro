...
win32:LIBPNG_INCLUDE_PATH=C:/deps/libpng-1.6.18
win32:LIBPNG_LIB_PATH=C:/deps/libpng-1.6.18/.libs
...
LIBS += $$PWD/src/secp256k1/src/libsecp256k1_la-secp256k1.o
    ...
    isEmpty(SECP256K1_LIB_PATH) {
        win32:SECP256K1_LIB_PATH=C:/secp256k1/.libs
    }
    isEmpty(SECP256K1_INCLUDE_PATH) {
        win32:SECP256K1_INCLUDE_PATH=C:/secp256k1/include
    }
}
...
macx:ICON = src/qt/res/icons/BitcoinFinal.icns
macx:TARGET = "BitcoinFinal-Qt"
